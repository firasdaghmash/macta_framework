...
// Configuration
$MODULE_LETTER = 'C'; // Change this for each module: A, C, T, A2
$MODULE_TITLE = 'Customization Module'; // Change this for each module
$MODULE_DESCRIPTION = 'A customization module based on the modeling and analysis.'; // Change this
...
$config = $MODULE_CONFIGS[$MODULE_LETTER] ?? $MODULE_CONFIGS['C'];
