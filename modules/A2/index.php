...
// Configuration
$MODULE_LETTER = 'A2'; // Change this for each module: A, C, T, A2
$MODULE_TITLE = 'Assessment (Metrics) Module'; // Change this for each module
$MODULE_DESCRIPTION = 'Metrics and score cards along with Dashboards and process indicators.'; // Change this
...
$config = $MODULE_CONFIGS[$MODULE_LETTER] ?? $MODULE_CONFIGS['A2'];
